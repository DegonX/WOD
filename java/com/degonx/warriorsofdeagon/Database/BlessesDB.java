...
public class BlessesDB extends SQLiteOpenHelper {
    ...
    public void createCharBless(int CharID) {
        ...
        values.put(KEY_CHARBLESS1, 0);
        values.put(KEY_CHARBLESS2, 0);
        values.put(KEY_CHARBLESS3, 0);
        values.put(KEY_CHARBLESS4, 0);
        values.put(KEY_CHARBLESS5, 0);
        values.put(KEY_CHARBLESS6, 0);
        values.put(KEY_CHARBLESS7, 0);
        values.put(KEY_CHARBLESS8, 0);
