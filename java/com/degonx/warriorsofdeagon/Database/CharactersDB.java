...
public class CharactersDB extends SQLiteOpenHelper {
    ...
    private static final String KEY_CHARELEMENT4 = "charElement4";
    private static final String KEY_CHARELEMENT5 = "charElement5";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        if (!tableExists(db)) {
            String CREATE_CHARACTERS_TABLE = "CREATE TABLE " + TABLE_CHARACTERS + "("
                    ...
                    + KEY_CHARELEMENT4 + " INTEGER,"
                    + KEY_CHARELEMENT5 + " INTEGER,"
                    + KEY_CHARHPPOT + " INTEGER,"
                    + KEY_CHARMPPOT + " INTEGER,"
                    + KEY_BLESSPOINTS + " INTEGER,"
                    + KEY_CURRENTAREA + " INTEGER" + ")";
    ...
    public void createCharacter(int charID, int charAccount, String charName, int ele1, int ele2) {
        ...
        values.put(KEY_CHARELEMENT4, 0);
        values.put(KEY_CHARELEMENT5, 0);
        values.put(KEY_CHARHPPOT, 0);
        values.put(KEY_CHARMPPOT, 0);
        values.put(KEY_BLESSPOINTS, 0);
        values.put(KEY_CURRENTAREA, 1);
    ...
    public Character getCharacterData(int CharID) {
        ...
        if (cursor.moveToFirst()) {
            ...
            Data.setCharHPpots(Integer.parseInt(cursor.getString(11)));
            Data.setCharMPpots(Integer.parseInt(cursor.getString(12)));
            Data.setCharBlessPoints(Integer.parseInt(cursor.getString(13)));
            Data.setCharAreaID(Integer.parseInt(cursor.getString(14)));
        }
    ...
    public List<Elements> getCharacterElements(int CharID) {
        ...
        if (cursor.moveToFirst()) {
            ...
            charElements.add(Elements.values()[Integer.parseInt(cursor.getString(9))]);
            charElements.add(Elements.values()[Integer.parseInt(cursor.getString(10))]);
        }
    ...
    public void updatePotions(int charID, int pot, int Count) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void updateCurrentArea(int charID, int area) {
        SQLiteDatabase db = this.getWritableDatabase();
