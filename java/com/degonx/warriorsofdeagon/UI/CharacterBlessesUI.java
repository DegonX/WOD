...
public class CharacterBlessesUI {
    ...
    private void setBlessText(TextView blessInfo, Blesses bless, int blessLV) {
        ...
        //bless 1st add
        blessInfoStr += bless.Add1 + ":" + (int) BlessesData.getBlessBaseValue(bless.Add1, blessLV) + " \n ";

        //bless 2nd add
        if (!bless.Add2.equals("Critical Rate") && !bless.Add2.equals("XP Bonus"))
            blessInfoStr += bless.Add2 + ":" + (int) BlessesData.getBlessBaseValue(bless.Add2, blessLV) + " ";
        else
            blessInfoStr += bless.Add2 + ":" + String.format(Locale.ENGLISH, "%.2f", (BlessesData.getBlessBaseValue(bless.Add2, blessLV))) + " ";
    ...
    public void setActiveBlessesText(int active, double[] blessesStats) {
        activeBlessInfo.setText("Active blesses:" + active +
                "\nattack:" + (int) blessesStats[0] + ", defence:" + (int) blessesStats[1] + ", hp:" + (int) blessesStats[2] + ", mp:" + (int) blessesStats[3] +
