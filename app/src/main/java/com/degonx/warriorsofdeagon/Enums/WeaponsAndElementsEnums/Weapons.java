...
public enum Weapons {
    ...
    Warhammer(6, R.drawable.warhammer, SkillsEnum.WARHAMMER_MASTERY, WeaponAttacks.WARHAMMER_SWING, WeaponAttacks.WARHAMMER_SMASH, WeaponAttacks.WARHAMMER_SLAM, WeaponAttacks.WARHAMMER_GROUND_SMACK),
    Blood_Weapons(7, R.drawable.bloodweapons, SkillsEnum.BLOOD_WEAPONS_MASTERY, WeaponAttacks.BLOOD_WEAPONS_FIST, WeaponAttacks.BLOOD_WEAPONS_CLAW, WeaponAttacks.BLOOD_WEAPONS_DRAIN, WeaponAttacks.BLOOD_WEAPONS_CRASH);
